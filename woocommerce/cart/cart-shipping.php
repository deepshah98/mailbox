...
<tr class="shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if (isset($available_methods['free_shipping:1']) || isset($available_methods['free_shipping:2'])) {
			$method = isset($available_methods['free_shipping:1']) ? $available_methods['free_shipping:1'] : $available_methods['free_shipping:2'];
